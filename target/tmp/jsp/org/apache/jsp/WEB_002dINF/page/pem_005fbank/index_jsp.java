package org.apache.jsp.WEB_002dINF.page.pem_005fbank;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function(){\r\n");
      out.write("\t$(\"#pem_bank_detail\").datagrid({\r\n");
      out.write("\t\ttitle:'银行卡信息',\r\n");
      out.write("\t\tloadMsg:\"正在加载请稍后\",\r\n");
      out.write("\t\tfitColumns:true,\r\n");
      out.write("\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${path}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/pem/pem_bank/getAll',\r\n");
      out.write("\t\ttoolbar: [{\r\n");
      ...
      out.write("\t\tcolumns:[[   \r\n");
      out.write("\t\t            {field:'bankCode',title:'银行卡号',width:100,align:'center'},   \r\n");
      out.write("\t\t            {field:'bankName',title:'银行名称',width:100,align:'center'},\r\n");
      out.write("\t\t            {field:'type',title:'持卡类型',width:100,align:'center'}\r\n");
      out.write("\t\t        ]] \r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("\t$(\"#pem_bank_dialog\").dialog({\r\n");
      out.write("\t    title: '添加银行卡',  \r\n");
      out.write("\t    href:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${path}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/pem/pem_bank/add',\r\n");
      out.write("\t    width: 450,   \r\n");
      ...
      out.write("\r\n");
      out.write("//银行卡添加\r\n");
      out.write("function pem_bank_submit(){\r\n");
      out.write("\t\t$(\"#pem_bank_form\").form(\"submit\",{\r\n");
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${path}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/pem/pem_bank/addPem_bank',\r\n");
      out.write("\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\tif(data=='success'){\r\n");
      out.write("\t\t\t\t\t$(\"#pem_bank_dialog\").dialog(\"close\");\r\n");
      out.write("\t\t\t\t\t$(\"#pem_bank_detail\").datagrid('reload');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t\t\t<div id=\"pem_bank_detail\"></div>\r\n");
      out.write("\t\t\t<div id=\"pem_bank_dialog\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
